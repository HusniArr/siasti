    ...
    <form action="{{ route('laporan.show') }}" method="GET">
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <a href="{{ url('laporan/export_excel?tgl_mulai='.Request::get('tgl_mulai').'&tgl_akhir='.Request::get('tgl_akhir').'')}}" class="btn btn-md btn-outline-success export-excel" ><i class="far fa-file-excel fa-fw"></i>Export</a>
            </div>
        </div>
    </form>
    <div class="mb3">
