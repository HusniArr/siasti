...
<div class="container-fluid px-4">
    ...
    <form action="{{ url('siswa/'.$row->id.'/edit') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="form-floating mb-2">
                    <input class="form-control @error('nis') is-invalid @enderror" id="nis" name="nis" type="text" value="{{ $row->nis }}" readonly/>
            ...
            <div class="col-md-6">
                <div class="form-floating mb-2">
                    <input class="form-control @error('nm_siswa') is-invalid @enderror" id="nm_siswa" name="nm_siswa" type="text" value="{{ $row->nm_siswa }}" autocomplete="off"/>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="jns_kel" id="jns_kel" value="L" {{ ($row->jns_kel == "L") ? "checked" : ""}}>
                    <label class="form-check-label" for="jns_kel">
                      Laki - laki
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="jns_kel" id="jns_kel" value="P" {{ ($row->jns_kel == 'P')? "checked" : ""}}>
                    <label class="form-check-label" for="jns_kel">
                      Perempuan
                    </label>
                  </div>
